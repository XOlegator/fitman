...
message:i18n.gettext("Option ")+b.option+i18n.gettext(" already used in database. It can not be deleted!")}),$$('input[name="checkbox-ex-prop"][value="'+b.option+'"]').prop("checked",!1)):(server.remove("optionsExercises",parseInt(b.id)),console.log("\u0423\u0434\u0430\u043b\u0438\u043b\u0438 \u0441\u0432\u044f\u0437\u043a\u0443 \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440-\u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0435 \u0441 id = "+b.id))}))});for(var g in a)in_array(a[g],c)||(f.push(a[g]),
server.optionsExercises.add({option:a[g],exerciseId:b}).then(function(a){console.log("\u0414\u043e\u0431\u0430\u0432\u0438\u043b\u0438 \u0441\u0432\u044f\u0437\u043a\u0443 \u043e\u043f\u0446\u0438\u044f-\u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0435: "+JSON.stringify(a))}));d.length||f.length||myApp.addNotification({title:i18n.gettext("Nothing to save"),hold:messageDelay,message:i18n.gettext("New set of options are equal to existent.")})})}
...
k?0:parseInt(k);server.workExercise.update({id:parseInt(g.id),customer:b,date:c,exercise:a,option:g.option,value:k+g.value,set:d}).then(function(a){console.log("\u041e\u0431\u043d\u043e\u0432\u0438\u043b\u0438 \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u0443\u044e \u0441\u0442\u0440\u043e\u043a\u0443 \u0432 \u0411\u0414 (\u0441\u043b\u043e\u0436\u0438\u043b\u0438 \u043f\u043e\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0438): "+JSON.stringify(a));e++;1==e&&myApp.addNotification({title:i18n.gettext("Data was saved"),
...
g),server.workExercise.add({customer:b,date:c,exercise:a,option:"time",value:g,set:d}).then(function(a){l++;1==l&&myApp.addNotification({title:i18n.gettext("Data was saved"),hold:messageDelay,message:i18n.gettext("Data was added")})}))}})}function makeCalDate(b){var a=b.getDate().toString(),c=1+b.getMonth();b=b.getFullYear().toString();2>a.length&&(a="0"+a);c=c.toString();2>c.length&&(c="0"+c);return b+"-"+c+"-"+a}
...
!1)))});
function generateStatistics(){$$("#linkSaveWorkEx").show();var b=parseInt($$("span#spanCustName").data("item"));$$("span#spanDateEx").text();var a=parseInt($$("#spanExWork").data("item")),c=0;server.optionsExercises.query().filter("exerciseId",a).execute().then(function(d){var f=d.length;console.log("\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u0432\u0441\u0435\u0445 \u0441\u043e\u0431\u0440\u0430\u043d\u043d\u044b\u0445 \u0438\u0437 \u0411\u0414 \u0445\u0430\u0440\u0430\u043a\u0442\u0435\u0440\u0438\u0441\u0442\u0438\u043a: "+f);
...
"repeats"===p.option?e[b]=p.value:"weight"===p.option?f[b]=p.value:"time"===p.option?k[b]=p.value/60:"distance"===p.option?r[b]=p.value:"speed"===p.option?s[b]=p.value:"slope"===p.option?t[b]=p.value:"load"===p.option&&(u[b]=p.value);d++;d===g&&(d=0,b++);console.log("\u041d\u043e\u043c\u0435\u0440 \u0445\u0430\u0440\u0430\u043a\u0442\u0435\u0440\u0438\u0441\u0442\u0438\u043a\u0438 \u0432 \u0442\u0435\u043a\u0443\u0449\u0435\u0439 \u0438\u0442\u0435\u0440\u0430\u0446\u0438\u0438: "+d)}a={labels:c,
series:[{name:i18n.gettext("Repeats"),data:e},{name:i18n.gettext("Weight"),data:f},{name:i18n.gettext("Time"),data:k},{name:i18n.gettext("Distance"),date:r},{name:i18n.gettext("Speed"),data:s},{name:i18n.gettext("Slope"),data:t},{name:i18n.gettext("Load"),data:u}]};console.log("\u0421\u043e\u0431\u0438\u0440\u0430\u0435\u043c \u0434\u0430\u043d\u043d\u044b\u0435 \u0432 \u043c\u0430\u0441\u0441\u0438\u0432\u044b \u0434\u043b\u044f \u043f\u043e\u043a\u0430\u0437\u0430 \u043d\u0430 \u0433\u0440\u0430\u0444\u0438\u043a\u0435.");
