...
JSON.stringify(b));for(var c in b){var f=b[c];console.log("rowExOpt.option = "+f.option);if("time"===f.option)a+="<li>",a+='  <div class="item-content">',a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>',a+='    <div class="item-inner">',a+='      <div class="item-title label">'+i18n.gettext("Time")+"</div>",a+='      <div class="item-input">',a+='        <div class="row">',a+='          <div class="col-33"><input type="number" min="0" data-item="time-minutes" placeholder="'+
i18n.gettext("Minutes")+'"></div>',a+='          <div class="col-33"><input type="number" min="0" data-item="time-seconds" placeholder="'+i18n.gettext("Seconds")+'"></div>',a+='          <div class="col-33"><a href="#" class="button" onclick="launcherTimer()">'+i18n.gettext("Start timer")+"</a></div>",a+="        </div>",a+="      </div>",a+="    </div>",a+="  </div>",a+="</li>";else if("repeats"===f.option){a+="<li>";a+='  <div class="item-content">';a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>';
a+='    <div class="item-inner">';a+='      <div class="item-title label">'+i18n.gettext("Repeats")+"</div>";a+='      <div class="item-input">';a+='        <select data-item="sets">';for(i=0;9>=i;i++)a+="          <option>"+i+"</option>";a+="        </select>";a+="      </div>";a+="    </div>";a+="  </div>";a+="</li>"}else if("incline"===f.option){a+="<li>";a+='  <div class="item-content">';a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>';a+='    <div class="item-inner">';
a+='      <div class="item-title label">'+i18n.gettext("Incline")+"</div>";a+='      <div class="item-input">';a+='        <select data-item="sets">';for(i=0;9>=i;i++)a+="          <option>"+i+"</option>";a+="        </select>";a+="      </div>";a+="    </div>";a+="  </div>";a+="</li>"}else"weight"===f.option?(a+="<li>",a+='  <div class="item-content">',a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>',a+='    <div class="item-inner">',a+='      <div class="item-title label">'+
i18n.gettext("Weight")+"</div>",a+='      <div class="item-input">',a+='        <input type="number" min="0" max="400" data-item="'+f.option+'" placeholder="'+i18n.gettext("Value")+'">',a+="      </div>",a+="    </div>",a+="  </div>",a+="</li>"):"distance"===f.option?(a+="<li>",a+='  <div class="item-content">',a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>',a+='    <div class="item-inner">',a+='      <div class="item-title label">'+i18n.gettext("Distance")+"</div>",
a+='      <div class="item-input">',a+='        <input type="number" min="0" max="100" data-item="'+f.option+'" placeholder="'+i18n.gettext("Value")+'">',a+="      </div>",a+="    </div>",a+="  </div>",a+="</li>"):"speed"===f.option?(a+="<li>",a+='  <div class="item-content">',a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>',a+='    <div class="item-inner">',a+='      <div class="item-title label">'+i18n.gettext("Speed")+"</div>",a+='      <div class="item-input">',a+=
'        <input type="number" min="0" max="80" data-item="'+f.option+'" placeholder="'+i18n.gettext("Value")+'">',a+="      </div>",a+="    </div>",a+="  </div>",a+="</li>"):"resistance"===f.option&&(a+="<li>",a+='  <div class="item-content">',a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>',a+='    <div class="item-inner">',a+='      <div class="item-title label">'+i18n.gettext("Resistance")+"</div>",a+='      <div class="item-input">',a+='        <input type="number" min="0" data-item="'+
...
e.option+"; item.value = "+e.value);if("time"==e.option)var h=$$('#ulListCurrentWorkEx input[data-item = "time-minutes"]').val(),h=""==h?0:parseInt(h),r=$$('#ulListCurrentWorkEx input[data-item = "time-seconds"]').val(),h=(""==r?0:parseInt(r))+60*h;else h=$$('#ulListCurrentWorkEx input[data-item = "'+e.option+'"]').val(),h=""==h?0:parseInt(h);server.workExercise.update({id:parseInt(e.id),customer:c,date:a,exercise:b,option:e.option,value:h,set:d}).then(function(a){console.log("\u041e\u0431\u043d\u043e\u0432\u0438\u043b\u0438 \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u0443\u044e \u0441\u0442\u0440\u043e\u043a\u0443 \u0432 \u0411\u0414: "+
JSON.stringify(a));f++;1==f&&myApp.addNotification({title:i18n.gettext("Updated"),hold:messageDelay})})}}},{text:i18n.gettext("Cancel"),bold:!0,onClick:function(){}}]});else{console.log("\u041f\u043e \u0442\u0435\u043a\u0443\u0449\u0435\u043c\u0443 \u0430\u043d\u0430\u043b\u0438\u0442\u0438\u0447\u0435\u0441\u043a\u043e\u043c\u0443 \u0440\u0430\u0437\u0440\u0435\u0437\u0443 \u043d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e");var f="",l=0,k=0,e=0;$$("#ulListCurrentWorkEx li input").each(function(g,
m){console.log("item.value "+m.value+"; item.attributes[data-item].value "+m.attributes["data-item"].value);f=m.attributes["data-item"].value;if("time-minutes"===f){k=1;var p=$$(this).val(),p=""==p?0:parseInt(p);l+=60*p}else"time-seconds"===f?(k=1,p=$$(this).val(),p=""==p?0:parseInt(p),l+=p):(p=$$(this).val(),console.log("tempValue = "+p),p=""==p?0:parseInt(p),console.log("\u041f\u0435\u0440\u0435\u0434 \u0437\u0430\u043f\u0438\u0441\u044c\u044e: customerId = "+c+"; dateEx = "+a+"; exerciseId = "+
b+"; option = "+f+"; intValue = "+p+"; workSet = "+d),server.workExercise.add({customer:c,date:a,exercise:b,option:f,value:p,set:d}).then(function(a){console.log("\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c, \u0447\u0442\u043e \u0437\u0430\u043f\u0438\u0441\u0430\u043b\u0438: "+JSON.stringify(a));e++;1==e&&myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay})}))});k&&(console.log("\u0414\u043e\u0431\u0430\u0432\u043b\u044f\u0435\u043c \u0432\u0440\u0435\u043c\u044f \u0432\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u044f \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f \u0432 \u0431\u0430\u0437\u0443. time = "+
