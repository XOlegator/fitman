...
$$.getJSON(path+"default/customers.json",function(c){for(var b in c.customers)server.customers.add(c.customers[b]);server.customers.query("name").all().distinct().execute().then(function(a){updateListCustomers(a)})});myApp.alert(i18n.gettext("Enjoy your new demo data"))})});
...
JSON.stringify(b));for(var k in b){var e=b[k];console.log("\u041e\u0447\u0435\u0440\u0435\u0434\u043d\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430 \u0434\u043b\u044f \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u044f: "+JSON.stringify(e));d[k]=e.option;in_array(e.option,a)||(console.log("\u042d\u043b\u0435\u043c\u0435\u043d\u0442 \u0443\u0434\u0430\u043b\u0438\u043b\u0438 \u043d\u0430 \u0444\u043e\u0440\u043c\u0435: "+e.option),g.push(e.option))}for(var n in g)b=
parseInt($$('input[name="checkbox-ex-prop"][value="'+g[n]+'"]').data("item")),console.log("idForDelete = "+b),server.remove("optionsExercises",b).then(function(a){console.log("resDel = "+a);a=$$('input[name="checkbox-ex-prop"][data-item="'+a+'"]').val();$$('input[name="checkbox-ex-prop"][value="'+a+'"]').removeAttr("data-item");console.log("nameDeletedParameter = "+a);myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay,message:i18n.gettext("Parameter")+" "+i18n.gettext(a.charAt(0).toUpperCase()+
a.substr(1))+" "+i18n.gettext("was removed.")});console.log("\u0423\u0434\u0430\u043b\u0438\u043b\u0438 \u0441\u0432\u044f\u0437\u043a\u0443 \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440: "+a)});for(var m in a)in_array(a[m],d)||f.push(a[m]);for(var p in f)server.optionsExercises.add({option:f[p],exerciseId:c}).then(function(a){$$('input[name="checkbox-ex-prop"][value="'+a[0].option+'"]').attr("data-item",a[0].id);myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay,message:i18n.gettext("Parameter")+
...
e.option+"; item.value = "+e.value);if("time"===e.option)var h=$$('#ulListCurrentWorkEx input[data-item = "time-minutes"]').val(),h=""==h?0:parseInt(h),r=$$('#ulListCurrentWorkEx input[data-item = "time-seconds"]').val(),r=(""==r?0:parseInt(r))+60*h;else"incline"===e.option?h=parseInt($$('select[data-item="incline"]').val()):(h=$$('#ulListCurrentWorkEx input[data-item = "'+e.option+'"]').val(),r=""==h?0:parseInt(h));server.workExercise.update({id:parseInt(e.id),customer:c,date:a,exercise:b,option:e.option,
...
c),b.addClass("selected-day"))})},onMonthYearChangeStart:function(a){$$(".calendar-custom-toolbar .center").text(m[a.currentMonth]+", "+a.currentYear)},onDayClick:function(b,c,d,e,g){console.log("\u041d\u0430\u0436\u0430\u043b\u0438 \u043d\u0430 \u0434\u0430\u0442\u0443 "+d+"-"+(parseInt(e)+1)+"-"+g);c=makeCalDate(new Date(d,e,g));if(in_array(c,a)){console.log("\u041d\u0430 \u044d\u0442\u0443 \u0434\u0430\u0442\u0443 \u0435\u0441\u0442\u044c \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0441 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439!");
