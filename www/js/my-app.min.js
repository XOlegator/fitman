...
b.id);console.log(JSON.stringify(a));server.customers.query("name").all().distinct().execute().then(function(a){console.log("\u041a\u043b\u0438\u0435\u043d\u0442\u044b \u043f\u043e\u0441\u043b\u0435 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u044f res2 = "+JSON.stringify(a));updateListCustomers(a)})})})})})})})},function(){})}var myPhotoBrowserDark=myApp.photoBrowser({photos:[{url:"",caption:""}]});$$("#aCustomerPhoto").on("click",function(){myPhotoBrowserDark.open()});
...
b);server.customers.get(parseInt(b)).then(function(a){$$("input#inputNewCustomer").val(a.name);$$("#inputNewCustomer").attr("data-item",b);$$("textarea#newCustomerComments").val(a.comments);myPhotoBrowserDark=myApp.photoBrowser({photos:[{url:"./photo/"+a.photo,caption:a.name}]})})}function showEditLinkCustomer(){console.log("\u041f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0435\u043c \u043a\u043d\u043e\u043f\u043a\u0443 Update");$$("#linkEditCustomer").show()}
...
b+", \u0434\u0430\u0442\u0430 "+d);server.workout.query().filter(function(a){return a.date===d&&a.customer===c}).execute().then(function(b){var d="";if(b.length){console.log("\u041d\u0430\u0448\u043b\u0438 \u0432 \u0431\u0430\u0437\u0435 \u0434\u0430\u043d\u043d\u044b\u0435 \u043f\u043e \u0437\u0430\u043d\u044f\u0442\u0438\u044f\u043c \u043d\u0430 \u0441\u0435\u0433\u043e\u0434\u043d\u044f: "+JSON.stringify(b));for(var g in b){var h=b[g];console.log("\u041e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u043c \u043f\u0435\u0440\u0432\u043e\u0435 \u0437\u0430\u043d\u044f\u0442\u0438\u0435 \u043d\u0430 \u0441\u0435\u0433\u043e\u0434\u043d\u044f. item = "+
JSON.stringify(h));server.exercise.get(h.exercise).then(function(a){console.log("\u0412\u043e\u0442, \u0447\u0442\u043e \u043d\u0430\u0448\u043b\u0438 \u043f\u043e \u0442\u0435\u043a\u0443\u0449\u0435\u043c\u0443 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044e: "+JSON.stringify(a));var b=a.name;d+="<li>";d+='  <a href="#view-24" class="tab-link item-link item-content" onclick="makeViewExWork('+a.id+')">';d+='    <div class="item-inner">';d+='      <span data-item="'+a.id+'">'+b+"</span>";
...
break;case 2:nameToday="tuesday";break;case 3:nameToday="wednesday";break;case 4:nameToday="thursday";break;case 5:nameToday="friday";break;case 6:nameToday="saturday"}console.log("\u0421\u0435\u0433\u043e\u0434\u043d\u044f: "+nameToday);for(var c in b)if(h=b[c],h.day===nameToday||"everyday"===h.day)server.exercise.get(h.exercise).then(function(a){var b=a.name;d+="<li>";d+='  <a href="#view-24" class="tab-link item-link item-content" onclick="makeViewExWork('+a.id+')">';d+='    <div class="item-inner">';
