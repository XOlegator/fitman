...
g+" \u0441 id = "+e);$$("#ulListAllExWithTypes").append('<li class="item-divider" data-item="'+e+'">'+g+"</li>");console.log("\u0414\u043e\u0431\u0430\u0432\u0438\u043b\u0438 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u043e\u0439 \u0433\u0440\u0443\u043f\u043f\u044b \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439: "+g+" \u0441 id = "+e);server.exercise.query("name").filter("type",parseInt(e)).execute().then(function(a){for(var b in a){var d=
a[b].id,e=a[b].name,f=a[b].type;if(!in_array(e,c)){console.log("\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u043b\u0438, \u0447\u0442\u043e \u044d\u0442\u043e\u0433\u043e \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f \u043d\u0435\u0442 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0441\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0439: "+e);var k="",k=k+'<li class="swipeout swipeout-all">',k=k+'  <div class="swipeout-content item-content">',k=k+'    <div class="item-inner">',k=k+
('      <div class="item-title" data-item="'+d+'">'+e+"</div>"),k=k+"      </div>",k=k+"    </div>",k=k+"  </div>",k=k+'  <div class="swipeout-actions-right">',k=k+'    <a href="#" class="action1">Added</a>',k=k+"  </div>",k=k+"</li>";$$("#ulListAllExWithTypes").find('li.item-divider[data-item="'+f+'"]').append(k)}}a.length=0})}})}
...
b=b+('  <center><a href="#tab0" class="tab-link" onclick="makeScheduleCustomer()">'+i18n.gettext("Save")+"</a></center>"),b=b+"</div>";document.getElementById("divMenuWorkout").innerHTML=b;b=parseInt($$("span#spanCustName").data("item"));$$("span#spanDateEx").text();var a=[];if($$("#ulListCurrentExercises li a div span")){var c="";$$("#ulListCurrentExercises li a div span").each(function(b,f){var e=f.innerHTML.replace(/<script[^>]*>[\S\s]*?<\/script[^>]*>/ig,""),g=parseInt($$(this).data("item"));
a.push(g);c+="<li>";c+='  <div class="item-link item-content">';c+='    <div class="item-inner">';c+='      <span data-item="'+g+'">'+e+"</span>";c+="    </div>";c+="  </div>";c+="</li>";document.getElementById("ulListScheduleEx").innerHTML=c});server.schedule.query("day").filter("customer",b).execute().then(function(b){var c=[],e=[],g=0,h=b.length;console.log("\u0420\u0430\u0437\u043c\u0435\u0440 \u043d\u0430\u0439\u0434\u0435\u043d\u043d\u043e\u0433\u043e \u043c\u0430\u0441\u0441\u0438\u0432\u0430 = "+
