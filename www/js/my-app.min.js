...
JSON.stringify(a))})})});
$$(".confirm-fill-demo").on("click",function(){myApp.confirm(i18n.gettext("Are you sure? It will erase all of your data!"),function(){console.log(JSON.stringify(server));server.clear("workExercise");server.clear("schedule");server.clear("workout");server.clear("optionsExercises");server.clear("exercise");server.clear("exerciseType");server.clear("customers");console.log("\u041d\u0430\u0447\u0438\u043d\u0430\u0435\u043c \u043e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0442\u044c \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f");$$.getJSON(path+
"default/exercises.json",function(c){for(var b in c.exerciseType)server.exerciseType.add({id:c.exerciseType[b].id,name:c.exerciseType[b].name}).then(function(a){var b=c.exerciseType[parseInt(a[0].id)].exercises,g;for(g in b){var f=b[g].name,m=parseInt(b[g].id);server.exercise.add({id:m,name:f,type:parseInt(a[0].id),deleted:0}).then(function(a){})}for(var k in b)for(var e in b[k].options[0])b[k].options[0][e]&&(m=b[k].id,server.optionsExercises.add({option:e,exerciseId:m}).then(function(a){console.log("\u0414\u043e\u0431\u0430\u0432\u0438\u043b\u0438 \u0432 \u0411\u0414 \u043d\u043e\u0432\u0443\u044e \u0441\u0432\u044f\u0437\u043a\u0443 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f \u0441 \u0430\u043a\u0442\u0438\u0432\u043d\u044b\u043c \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u043e\u043c: "+
JSON.stringify(a))}))});server.exerciseType.query("name").all().distinct().execute().then(function(a){updateListExerciseType(a)})});$$.getJSON(path+"default/customers.json",function(c){for(var b in c.customers)server.customers.add(c.customers[b]);server.customers.query("name").all().distinct().execute().then(function(a){updateListCustomers(a)})});myApp.alert(i18n.gettext("Enjoy your new demo data"))})});
...
function updateExerciseProperties(){var c=parseInt($$("#ex-prop").data("item"));console.log("\u0418\u0434\u0451\u0442 \u043e\u0431\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u043e\u0432 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f \u0441 id = "+c);server.workExercise.query().filter("exercise",c).execute().then(function(b){if(b.length)myApp.addNotification({title:i18n.gettext("Error"),hold:messageDelay,message:i18n.gettext("Parameters of exercise can't be change, as there is a history of this exercise.")});
else{var a=[],d=[],g=[],f=[];$$('input[name="checkbox-ex-prop"]:checked').each(function(b,c){a[b]=c.value;console.log("\u0417\u0430\u043d\u0435\u0441\u043b\u0438 \u0432 \u043c\u0430\u0441\u0441\u0438\u0432 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u0432\u044b\u0434\u0435\u043b\u0435\u043d\u043d\u043e\u0439 \u043e\u043f\u0446\u0438\u0438: "+c.value)});server.optionsExercises.query().filter("exerciseId",c).execute().then(function(b){console.log("\u0421\u043f\u0438\u0441\u043e\u043a \u0445\u0430\u0440\u0430\u043a\u0442\u0435\u0440\u0438\u0441\u0442\u0438\u043a: "+
JSON.stringify(b));for(var k in b){var e=b[k];console.log("\u041e\u0447\u0435\u0440\u0435\u0434\u043d\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430 \u0434\u043b\u044f \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u044f: "+JSON.stringify(e));d[k]=e.option;in_array(e.option,a)||(console.log("\u042d\u043b\u0435\u043c\u0435\u043d\u0442 \u0443\u0434\u0430\u043b\u0438\u043b\u0438 \u043d\u0430 \u0444\u043e\u0440\u043c\u0435: "+e.option),g.push(e.option))}for(var p in g)b=
parseInt($$('input[name="checkbox-ex-prop"][value="'+g[p]+'"]').data("item")),console.log("idForDelete = "+b),server.remove("optionsExercises",b).then(function(a){console.log("resDel = "+a);a=$$('input[name="checkbox-ex-prop"][data-item="'+a+'"]').val();$$('input[name="checkbox-ex-prop"][value="'+a+'"]').removeAttr("data-item");console.log("nameDeletedParameter = "+a);myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay,message:i18n.gettext("Parameter")+" "+i18n.gettext(a.charAt(0).toUpperCase()+
a.substr(1))+" "+i18n.gettext("was removed.")});console.log("\u0423\u0434\u0430\u043b\u0438\u043b\u0438 \u0441\u0432\u044f\u0437\u043a\u0443 \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440: "+a)});for(var n in a)in_array(a[n],d)||f.push(a[n]);for(var l in f)server.optionsExercises.add({option:f[l],exerciseId:c}).then(function(a){$$('input[name="checkbox-ex-prop"][value="'+a[0].option+'"]').attr("data-item",a[0].id);myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay,message:i18n.gettext("Parameter")+
" "+i18n.gettext(a[0].option.charAt(0).toUpperCase()+a[0].option.substr(1))+" "+i18n.gettext("was added.")});console.log("\u0414\u043e\u0431\u0430\u0432\u0438\u043b\u0438 \u0441\u0432\u044f\u0437\u043a\u0443 \u043e\u043f\u0446\u0438\u044f-\u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0435: "+JSON.stringify(a))});g.length||f.length||myApp.addNotification({title:i18n.gettext("Nothing to save"),hold:messageDelay,message:i18n.gettext("New set of options are equal to existent.")})})}})}
...
"";if(c.length){console.log("\u041d\u0430\u0448\u043b\u0438 \u0432 \u0431\u0430\u0437\u0435 \u0434\u0430\u043d\u043d\u044b\u0435 \u043f\u043e \u0437\u0430\u043d\u044f\u0442\u0438\u044f\u043c \u043d\u0430 \u0441\u0435\u0433\u043e\u0434\u043d\u044f: "+JSON.stringify(c));for(var m in c){var k=c[m];console.log("\u041e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u043c \u043f\u0435\u0440\u0432\u043e\u0435 \u0437\u0430\u043d\u044f\u0442\u0438\u0435 \u043d\u0430 \u0441\u0435\u0433\u043e\u0434\u043d\u044f. item = "+
...
server.exerciseType.query("name").all().execute().then(function(b){console.log("\u0424\u043e\u0440\u043c\u0438\u0440\u0443\u0435\u043c \u0441\u043f\u0438\u0441\u043e\u043a \u0433\u0440\u0443\u043f\u043f \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439");for(var c in b){var f=b[c].id,m=b[c].name;console.log("\u0422\u0435\u043a\u0443\u0449\u0430\u044f \u0433\u0440\u0443\u043f\u043f\u0430 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439: "+m+" \u0441 id = "+f);$$("#ulListAllExWithTypes").append('<li class="item-divider" data-item="'+
f+'">'+m+"</li>");console.log("\u0414\u043e\u0431\u0430\u0432\u0438\u043b\u0438 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u043e\u0439 \u0433\u0440\u0443\u043f\u043f\u044b \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439: "+m+" \u0441 id = "+f)}server.exercise.query("name").filter(function(b){return 0==b.deleted&&!in_array(b.id,a)}).execute().then(function(a){console.log("exTypeId = "+f);console.log("\u0412\u0441\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043d\u044b\u0435 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f: "+
...
$$(this).data("item"));var p=parseInt($$(this).data("item"));server.workout.add({customer:g,date:f,exercise:p});d+="<li>";d+='  <a href="#view-24" class="tab-link item-link item-content" onclick="makeViewExWork('+p+')">';d+='    <div class="item-inner">';d+='      <span data-item="'+p+'">'+e+"</span>";d+="    </div>";d+="  </a>";d+="</li>";document.getElementById("ulListCurrentExercises").innerHTML=d}):$$("div.set-of-exercises").each(function(b,c){a=c.innerHTML;exerciseName=a.replace(/<script[^>]*>[\S\s]*?<\/script[^>]*>/ig,
...
a+='    <div class="item-inner">',a+='      <div class="item-title label">'+i18n.gettext("Repeats")+"</div>",a+='      <div class="item-input">',a+='        <input class="myInput" type="number" min="0" data-item="'+f.option+'" placeholder="'+i18n.gettext("Value")+'">',a+="      </div>",a+="    </div>",a+="  </div>",a+="</li>";else if("incline"===f.option){a+="<li>";a+='  <div class="item-content">';a+='    <div class="item-media"><i class="icon icon-form-settings"></i></div>';a+='    <div class="item-inner">';
...
text:i18n.gettext("What do you want to do with current values?"),buttons:[{text:i18n.gettext("Rewrite"),onClick:function(){var f=0;console.log("\u041c\u044b \u0432 \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u0447\u0438\u043a\u0435 \u043f\u0435\u0440\u0435\u0437\u0430\u043f\u0438\u0441\u0438 \u0434\u0430\u043d\u043d\u044b\u0445 \u043f\u043e \u0432\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u044e \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f");for(var e in g){var l=g[e];console.log("\u0412 \u0431\u0430\u0437\u0435 \u043d\u0430\u0448\u043b\u043e\u0441\u044c: item.option = "+
l.option+"; item.value = "+l.value);if("time"===l.option)var h=$$('#ulListCurrentWorkEx input[data-item = "time-minutes"]').val(),h=""==h?0:parseInt(h),r=$$('#ulListCurrentWorkEx input[data-item = "time-seconds"]').val(),r=(""==r?0:parseInt(r))+60*h;else"incline"===l.option?h=parseInt($$('select[data-item="incline"]').val()):(h=$$('#ulListCurrentWorkEx input[data-item = "'+l.option+'"]').val(),r=""==h?0:parseInt(h));server.workExercise.update({id:parseInt(l.id),customer:c,date:a,exercise:b,option:l.option,
value:r,set:d}).then(function(a){console.log("\u041e\u0431\u043d\u043e\u0432\u0438\u043b\u0438 \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u0443\u044e \u0441\u0442\u0440\u043e\u043a\u0443 \u0432 \u0411\u0414: "+JSON.stringify(a));f++;1==f&&myApp.addNotification({title:i18n.gettext("Updated"),hold:messageDelay})})}}},{text:i18n.gettext("Cancel"),bold:!0,onClick:function(){}}]});else{console.log("\u041f\u043e \u0442\u0435\u043a\u0443\u0449\u0435\u043c\u0443 \u0430\u043d\u0430\u043b\u0438\u0442\u0438\u0447\u0435\u0441\u043a\u043e\u043c\u0443 \u0440\u0430\u0437\u0440\u0435\u0437\u0443 \u043d\u0438\u0447\u0435\u0433\u043e \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e");
var f="",m=0,k=0,e=0;$$(".myInput").each(function(g,n){console.log("item.value = "+n.value+"; item.attributes[data-item].value = "+n.attributes["data-item"].value);f=n.attributes["data-item"].value;if("time-minutes"===f){k=1;var l=$$(this).val(),l=""==l?0:parseInt(l);m+=60*l}else"time-seconds"===f?(k=1,l=$$(this).val(),l=""==l?0:parseInt(l),m+=l):(l=$$(this).val(),console.log("tempValue = "+l),l=""==l?0:parseInt(l),console.log("\u041f\u0435\u0440\u0435\u0434 \u0437\u0430\u043f\u0438\u0441\u044c\u044e: customerId = "+
c+"; dateEx = "+a+"; exerciseId = "+b+"; option = "+f+"; intValue = "+l+"; workSet = "+d),server.workExercise.add({customer:c,date:a,exercise:b,option:f,value:l,set:d}).then(function(a){console.log("\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c, \u0447\u0442\u043e \u0437\u0430\u043f\u0438\u0441\u0430\u043b\u0438: "+JSON.stringify(a));e++;1==e&&myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay})}))});k&&(console.log("\u0414\u043e\u0431\u0430\u0432\u043b\u044f\u0435\u043c \u0432\u0440\u0435\u043c\u044f \u0432\u044b\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u044f \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f \u0432 \u0431\u0430\u0437\u0443. time = "+
m),server.workExercise.add({customer:c,date:a,exercise:b,option:"time",value:m,set:d}).then(function(a){e++;1==e&&myApp.addNotification({title:i18n.gettext("Saved"),hold:messageDelay})}))}})}function makeCalDate(c){var b=c.getDate().toString(),a=1+c.getMonth();c=c.getFullYear().toString();2>b.length&&(b="0"+b);a=a.toString();2>a.length&&(a="0"+a);return c+"-"+a+"-"+b}
...
c;$$("#ulListPastExercises").html("");console.log("\u041d\u0430\u0447\u0438\u043d\u0430\u0435\u043c \u043f\u043e\u0434\u0433\u0440\u0443\u0436\u0430\u0442\u044c \u043a\u0430\u043b\u0435\u043d\u0434\u0430\u0440\u044c");c=parseInt($$("span#spanCustName").data("item"));server.workout.query().filter("customer",c).execute().then(function(b){var a=[],c="",g=0,f=[],m=$$("#spanDateEx").text(),k;for(k in b){var e=b[k],c=e.date;0==k?(a[0]=c,console.log("\u041f\u0435\u0440\u0432\u044b\u0439 \u0440\u0430\u0437. \u041d\u043e\u0432\u0430\u044f \u0434\u0430\u0442\u0430: "+
c),g=1):in_array(c,a)?g+=1:(a[g]=c,g=1,console.log("\u041d\u043e\u0432\u0430\u044f \u0434\u0430\u0442\u0430: "+c));f[c]=1<g?f[c]+"@#"+e.exercise:e.exercise}if(b.length&&in_array(m,a)){console.log("\u041e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u043c \u0442\u0435\u043a\u0443\u0449\u0443\u044e \u0434\u0430\u0442\u0443 (\u043e\u043d\u0430 \u043d\u0430\u0448\u043b\u0430\u0441\u044c \u0432 \u0431\u0430\u0437\u0435 \u0434\u0430\u043d\u044b\u0445)!");console.log("arrWorkEx[dateEx] = "+
f[m]);b=f[m].split("@#");var p="";for(k in b)server.exercise.get(parseInt(b[k])).then(function(a){console.log("rowExercise.name = "+a.name);p+="<li>";p+='  <div class="item-link item-content">';p+='    <div class="item-inner">';p+='      <span data-item="'+a.id+'">'+a.name+"</span>";p+="    </div>";p+="  </div>";p+="</li>";document.getElementById("ulListPastExercises").innerHTML=p})}var n="January February March April May June July August September October November December".split(" ");document.getElementById("calendar-inline-container").innerHTML=
"";console.log(a[0]);var l=myApp.calendar({container:"#calendar-inline-container",value:[new Date],weekHeader:!1,toolbarTemplate:'<div class="toolbar calendar-custom-toolbar"><div class="toolbar-inner"><div class="left"><a href="#" class="link icon-only"><i class="icon icon-back"></i></a></div><div class="center"></div><div class="right"><a href="#" class="link icon-only"><i class="icon icon-forward"></i></a></div></div></div>',onOpen:function(a){$$(".calendar-custom-toolbar .center").text(n[a.currentMonth]+
", "+a.currentYear);$$(".calendar-custom-toolbar .left .link").on("click",function(){l.prevMonth()});$$(".calendar-custom-toolbar .right .link").on("click",function(){l.nextMonth()})},onMonthAdd:function(b,c){$$(c).find(".picker-calendar-day").each(function(){var b=$$(this),c=b.attr("data-date").split("-"),d=makeCalDate(new Date(c[0],c[1],c[2]));console.log("dateText = "+d);in_array(d,a)&&(console.log("\u0421\u043e\u0432\u043f\u0430\u0434\u0435\u043d\u0438\u0435 \u0434\u0430\u0442\u044b \u043d\u0430\u0439\u0434\u0435\u043d\u043e: "+
c),b.addClass("selected-day"))})},onMonthYearChangeStart:function(a){$$(".calendar-custom-toolbar .center").text(n[a.currentMonth]+", "+a.currentYear)},onDayClick:function(b,c,d,g,e){console.log("\u041d\u0430\u0436\u0430\u043b\u0438 \u043d\u0430 \u0434\u0430\u0442\u0443 "+d+"-"+(parseInt(g)+1)+"-"+e);c=makeCalDate(new Date(d,g,e));if(in_array(c,a)){console.log("\u041d\u0430 \u044d\u0442\u0443 \u0434\u0430\u0442\u0443 \u0435\u0441\u0442\u044c \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0441 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439!");
b=[];b=f[c].split("@#");var n="",l;for(l in b)c=b[l],console.log("\u041c\u044b \u0432 \u0446\u0438\u043a\u043b\u0435 \u043f\u043e \u043a\u043e\u0434\u0430\u043c \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439. \u0422\u0435\u043a\u0443\u0449\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430: "+c),server.exercise.get(parseInt(c)).then(function(a){n+="<li>";n+='  <div class="item-link item-content">';n+='    <div class="item-inner">';n+='      <span data-item="'+a.id+'">'+a.name+"</span>";
n+="    </div>";n+="  </div>";n+="</li>";console.log("listExCust = "+n);document.getElementById("ulListPastExercises").innerHTML=n;console.log("\u041e\u0431\u043d\u043e\u0432\u0438\u043b\u0438 \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0441 \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439!")})}}})})}
...
c;c=parseInt($$("span#spanCustName").data("item"));$$("#ulListDays li input").prop("checked",!1);$$("span#spanDateEx").text();var b=[];if($$("#ulListCurrentExercises li a div span")){var a="";$$("#ulListCurrentExercises li a div span").each(function(c,g){var f=g.innerHTML.replace(/<script[^>]*>[\S\s]*?<\/script[^>]*>/ig,""),m=parseInt($$(this).data("item"));b.push(m);a+="<li>";a+='  <div class="item-link item-content">';a+='    <div class="item-inner">';a+='      <span data-item="'+m+'">'+f+"</span>";
a+="    </div>";a+="  </div>";a+="</li>";document.getElementById("ulListScheduleEx").innerHTML=a});server.schedule.query("day").filter("customer",c).execute().then(function(a){var c=[],f=[],m=0,k=a.length;console.log("\u0420\u0430\u0437\u043c\u0435\u0440 \u043d\u0430\u0439\u0434\u0435\u043d\u043d\u043e\u0433\u043e \u043c\u0430\u0441\u0441\u0438\u0432\u0430 = "+k);for(var e in a){var p=a[e];c[e]=p.day;console.log("\u041f\u0440\u043e\u0432\u0435\u0440\u044f\u0435\u043c \u0434\u0435\u043d\u044c "+p.day);
console.log("index = "+e);m=parseInt(e)+1;console.log("num = "+m+"; count = "+k);0<e&&c[e]!=c[e-1]||m==k?(m==k&&(console.log("\u041d\u043e\u0432\u0430\u044f \u0437\u0430\u043f\u0438\u0441\u044c \u0442\u043e\u0433\u043e \u0436\u0435 \u0434\u043d\u044f (\u043f\u043e\u0441\u043b\u0435\u0434\u043d\u044f\u044f): "+p.exercise),f.push(p.exercise)),console.log("arrExForCheck.sort().toString() = "+f.sort().toString()),console.log("arrWorkEx.sort().toString() = "+b.sort().toString()),console.log("\u0421\u0432\u0435\u0440\u044f\u0435\u043c \u043d\u0430\u0431\u043e\u0440\u044b \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u0439"),
f.sort().toString()===b.sort().toString()&&(console.log("\u041e\u0442\u043c\u0435\u0447\u0430\u0435\u043c \u0441\u043e\u0432\u043f\u0430\u0432\u0448\u0438\u0439 \u0434\u0435\u043d\u044c "+c[e-1]),$$('#ulListDays li input[value="'+c[e-1]+'"]').prop("checked",!0)),f.length=0):console.log("\u041d\u043e\u0432\u0430\u044f \u0437\u0430\u043f\u0438\u0441\u044c \u0442\u043e\u0433\u043e \u0436\u0435 \u0434\u043d\u044f: "+p.exercise);f.push(p.exercise)}})}server.schedule.query().filter("customer",c).execute().then(function(a){if(a.length){var b=
0,c=0,m=0,k=0,e=0,p=0,n=0,l=0,h;for(h in a)"sunday"===a[h].day?l++:"monday"===a[h].day?c++:"tuesday"===a[h].day?m++:"wednesday"===a[h].day?k++:"thursday"===a[h].day?e++:"friday"===a[h].day?p++:"saturday"===a[h].day?n++:"everyday"===a[h].day&&b++;$$('[id^="badgeCount"]').hide();l&&($$("#badgeCountSunday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise","There are %d scheduled exercises",l),l)),$$("#badgeCountSunday").show());c&&($$("#badgeCountMonday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise",
"There are %d scheduled exercises",c),c)),$$("#badgeCountMonday").show());m&&($$("#badgeCountTuesday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise","There are %d scheduled exercises",m),m)),$$("#badgeCountTuesday").show());k&&($$("#badgeCountWednesday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise","There are %d scheduled exercises",k),k)),$$("#badgeCountWednesday").show());e&&($$("#badgeCountThursday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise",
"There are %d scheduled exercises",e),e)),$$("#badgeCountThursday").show());p&&($$("#badgeCountFriday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise","There are %d scheduled exercises",p),p)),$$("#badgeCountFriday").show());n&&($$("#badgeCountSaturday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise","There are %d scheduled exercises",n),n)),$$("#badgeCountSaturday").show());b&&($$("#badgeCountEveryday").html(i18n.sprintf(i18n.ngettext("There is one scheduled exercise",
...
c;console.log("\u0421\u043e\u0445\u0440\u0430\u043d\u044f\u0435\u043c \u0440\u0430\u0441\u043f\u0438\u0441\u0430\u043d\u0438\u0435");var b=parseInt($$("span#spanCustName").data("item")),a=0,d=[];$$("#ulListDays input:checked").each(function(b,c){d.push($$(this).val());console.log("$$(this).val() = "+$$(this).val());"everyday"===$$(this).val()&&(a=1)});server.schedule.query().filter("customer",b).execute().then(function(c){for(var f in c){var m=c[f];(in_array(m.day,d)||a)&&server.remove("schedule",
parseInt(m.id))}for(var k in d)$$("#ulListScheduleEx span").each(function(){var a=parseInt($$(this).data("item"));console.log("\u041f\u043e\u043b\u0443\u0447\u0438\u043b\u0438 id \u0442\u0435\u043a\u0443\u0449\u0435\u0433\u043e \u0443\u043f\u0440\u0430\u0436\u043d\u0435\u043d\u0438\u044f: "+a);server.schedule.add({customer:b,day:d[k],exercise:a});console.log("\u0411\u044b\u043b\u0438 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u044b \u0442\u0430\u043a\u0438\u0435 \u0434\u0430\u043d\u043d\u044b\u0435: customer = "+
...
console.log("\u0421\u043f\u0438\u0441\u043e\u043a \u0432\u0441\u0435\u0445 \u0441\u043e\u0431\u0440\u0430\u043d\u043d\u044b\u0445 \u0438\u0437 \u0411\u0414 \u0445\u0430\u0440\u0430\u043a\u0442\u0435\u0440\u0438\u0441\u0442\u0438\u043a: "+JSON.stringify(a));server.workExercise.query().filter(function(a){return a.exercise===c&&a.customer===b}).execute().then(function(a){var b=0,c=[],f=[],g=[],h=[],r=[],v=[],w=[],x=[],y;for(y in a){var q=a[y];0===d&&(c[b]=q.date);console.log("item.option = "+q.option);
"repeats"===q.option?f[b]=q.value:"weight"===q.option?g[b]=q.value:"time"===q.option?h[b]=q.value/60:"distance"===q.option?r[b]=q.value:"speed"===q.option?v[b]=q.value:"incline"===q.option?w[b]=q.value:"resistance"===q.option&&(x[b]=q.value);d++;d===m&&(d=0,b++);console.log("\u041d\u043e\u043c\u0435\u0440 \u0445\u0430\u0440\u0430\u043a\u0442\u0435\u0440\u0438\u0441\u0442\u0438\u043a\u0438 \u0432 \u0442\u0435\u043a\u0443\u0449\u0435\u0439 \u0438\u0442\u0435\u0440\u0430\u0446\u0438\u0438: "+d)}a={labels:c,
series:[{name:i18n.gettext("Repeats"),data:f},{name:i18n.gettext("Weight"),data:g},{name:i18n.gettext("Time"),data:h},{name:i18n.gettext("Distance"),date:r},{name:i18n.gettext("Speed"),data:v},{name:i18n.gettext("Incline"),data:w},{name:i18n.gettext("Resistance"),data:x}]};console.log("\u0421\u043e\u0431\u0438\u0440\u0430\u0435\u043c \u0434\u0430\u043d\u043d\u044b\u0435 \u0432 \u043c\u0430\u0441\u0441\u0438\u0432\u044b \u0434\u043b\u044f \u043f\u043e\u043a\u0430\u0437\u0430 \u043d\u0430 \u0433\u0440\u0430\u0444\u0438\u043a\u0435.");
...
function makeSliderSchedules(){var c=parseInt($$("#spanCustName").data("item")),b=$$("#spanCustName").html();$$("#spanCustNameSchedule").html(b).attr("data-item",c);var a=0,d=0,g=0,f=0,m=0,k=0,e=0,p=0,n='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Everyday")+"</span>",l='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Sunday")+"</span>",h='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Monday")+"</span>",r='<div class="swiper-slide"><span class="my-title">'+
i18n.gettext("Tuesday")+"</span>",v='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Wednesday")+"</span>",w='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Thursday")+"</span>",x='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Friday")+"</span>",y='<div class="swiper-slide"><span class="my-title">'+i18n.gettext("Saturday")+"</span>";server.schedule.query().filter("customer",c).execute().then(function(b){console.log("\u041d\u0430\u0448\u043b\u0438 \u0434\u0430\u043d\u043d\u044b\u0435 \u043f\u043e \u0440\u0430\u0441\u043f\u0438\u0441\u0430\u043d\u0438\u044e: "+
JSON.stringify(b));for(var c in b){console.log("\u041e\u0431\u0440\u0430\u0431\u0430\u0442\u044b\u0432\u0430\u0435\u043c \u043e\u0447\u0435\u0440\u0435\u0434\u043d\u0443\u044e \u0441\u0442\u0440\u043e\u043a\u0443 \u0440\u0430\u0441\u043f\u0438\u0441\u0430\u043d\u0438\u044f: "+JSON.stringify(b[c]));console.log("scheduleSunday = "+l);var u='<span class="exerciseNameSchedule" data-item="'+b[c].id+'"></span>';"everyday"===b[c].day?(a++,n+=u):"sunday"===b[c].day?(d++,console.log("\u041e\u0447\u0435\u0440\u0435\u0434\u043d\u0430\u044f \u0441\u0442\u0440\u043e\u043a\u0430 \u0432\u043e\u0441\u043a\u0440\u0435\u0441\u0435\u043d\u044c\u044f: "+
u),l+=u):"monday"===b[c].day?(g++,h+=u):"tuesday"===b[c].day?(f++,r+=u):"wednesday"===b[c].day?(m++,v+=u):"thursday"===b[c].day?(k++,w+=u):"friday"===b[c].day?(e++,x+=u):"saturday"===b[c].day&&(p++,y+=u)}n=0==a?"":n+"</div>";0==d?l="":(l+="</div>",console.log("scheduleSunday = "+l));h=0==g?"":h+"</div>";r=0==f?"":r+"</div>";v=0==m?"":v+"</div>";w=0==k?"":w+"</div>";x=0==e?"":x+"</div>";y=0==p?"":y+"</div>";document.getElementById("swiperSchedule").innerHTML=n+l+h+r+v+w+x+y;myApp.swiper(".swiper-container-schedules",
